...
Справочники — это централизованное хранилище нормативно-справочной информации (НСИ) в Citeck. Они обеспечивают единую точку управления данными, которые повторно используются в документах и процессах: контрагентами, валютами, единицами измерения и другими бизнес-сущностями. Это исключает дублирование, поддерживает актуальность данных и ускоряет заполнение форм за счёт выбора из готовых списков.
