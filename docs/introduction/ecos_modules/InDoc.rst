...
Дополнительно укажите **Краткое содержание, Количество листов, Количество листов приложений, Местонахождение оригинала, Количество экземпляров, Примечание, Доставку, связь с Исходящим документом**.

В разделе **«Резолюция»** документ можно отправить на рассмотрение руководителю:

  -	установите флажок **«Нужна резолюция»**;
...
Исполнитель выполняет указанное в резолюции задание, при необходимости вносит комментарий и нажимает **«Исполнено»**.
