Модуль «Корреспонденция» Входящие
========================================

.. _ecos-order-indoc:

Модуль «ОРД» предназначен для автоматизации процесса работы с организационно-распорядительными документами: уставы, положения, правила, инструкции, регламенты, постановления, распоряжения, приказы, решения,
протоколы, договоры, акты, письма, справки и др.
