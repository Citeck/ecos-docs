...
Работа в модуле состоит из двух бизнес-процессов:
    ...
    2. Отдел кадров на основании полученной заявки подбирает кандидатов, назначает интервью и по итогам выбора кандидата закрывает заявку.
...
.. list-table::
      ...
      * - **Отклонена**
        - Заявка на подбор отклонена директором, инициатором или сотрудником отдела кадров.
...
Также можно указать комментарий в поле **«Комментарий»**.
...
Введите **фидбэк по техническому собеседованию** и выберите соответствующее решение:
...
В задаче **«Обработка ответа кандидата на оффер»** выберите соответствующее решение:
