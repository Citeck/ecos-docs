...
.. list-table::
      ...
      * - **Заказ пропуска**
        - Присваивается после создания пропуска на время выполнения задачи «Оформление пропуска».
      * - **Пропуск заказан**
...
Задача активна пока любой из назначенных сотрудников первым не вынесет решение об одобрении или отказе в выдаче пропуска.
