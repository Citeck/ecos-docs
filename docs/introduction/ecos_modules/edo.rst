...
Возможность подписывать договоры и дополнительные соглашения квалифицированной электронной подписью (КЭП) и обмениваться ими с контрагентами через провайдеров ЮЗДО.
...
.. attention::
       ...
       Для абонентов Диадока доступен сервис проверки `Автодиагностика <https://support.kontur.ru/diadoc/48442-avtodiagnostika>`_ 

       Сервис проверяет и исправляет:

        - настройки работы КриптоПро CSP;
        - установку и настройки драйверов носителей закрытых ключей;
        - установку сертификатов удостоверяющих центров;
        - установку Контур.Плагина и Контур.Доступа;
        - запуск необходимых служб;
        - другие настройки рабочего места.
...
Статус очереди изменится на **«Обработана»**. В карточке пакета будет доступен предпросмотр файла:
...
При создании договора установите флажок **«Подписание ЭЦП»**, заполните необходимые и обязательные поля, вложите основной документ в **«Содержимое»** или сгенерируйте его, дополнительные – в **«Документы»**, нажмите **«Создать»**:
