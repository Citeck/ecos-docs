...
Ввести данные о контактах по сделке и дополнительной информации можно в виджеты **«Контакты»**, **«Маркетинг»**, аналогично как :ref:`карточке лида<lead_contacts>`.
...
Создание платежа
"""""""""""""""""""
Для создания платежа по сделке в карточке сделки перейдите во вкладку **«Платежи»**:
...
Объединение с основной сделкой
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
.. warning::
  ...
  Значения конфигураций ``mail-inbox-crm`` и ``mail-inbox-activity`` считываются микросервисом **ecom** один раз — при старте приложения (Camel-маршрут собирается на этапе инициализации Spring-контекста).
