...
Карточка портфеля содержит виджет :ref:`«Активности» <widget_activities>`.
...
- :ref:`простого проекта<ept_simple_project>`, состоящего из задач и этапов, без спринтов и бэклога:
...
.. list-table::
      ...
      * - |
            ...
            .. image:: _static/ept/simple_01.png
                  :width: 500
                  :align: center

        - |

            .. image:: _static/ept/simple_02.png
                  :width: 500
                  :align: center

-  :ref:`scrum проекта<ept_scrum_project>`, поддерживающего спринты и бэклог:
...
В портфель так же можно перейти из проекта:

.. image:: _static/ept/projects_portfolio_03.png
       :width: 700
       :align: center

Карточка проекта содержит виджет :ref:`«Активности» <widget_activities>`.
...
.. image:: _static/ept/ws_settings.png
       :width: 700
       :align: center

См. подробно о :ref:`настройках рабочего пространства<workspace_settings>`
...
Раздел содержит список этапов проекта.

.. image:: _static/ept/simple_stage_01.png
       :width: 700
       :align: center
...
.. image:: _static/ept/simple_stage_02.png
       :width: 600
       :align: center

в поле **Этап/Родитель** укажите вложенность этапа в другой этап или задачу, если необходимо:

.. image:: _static/ept/simple_task_03.png
       :width: 600
       :align: center

Статус этапа при создании по умолчанию – **Открыт**.

Задачи проекта
""""""""""""""""""

Раздел содержит список задач проекта. Представлены задачи во всех статусах.

.. image:: _static/ept/simple_task_01.png
       :width: 700
       :align: center
...
.. image:: _static/ept/simple_task_02.png
       :width: 600
       :align: center

в поле **Этап/Родитель** укажите вложенность задачи в этап или другую задачу, если необходимо:

.. image:: _static/ept/simple_task_03.png
       :width: 600
       :align: center

Статус задачи при создании по умолчанию – **Новая**.


Диаграмма Ганта
""""""""""""""""""

Если в рабочее пространство проекта добавлен виджет :ref:`«Диаграмма Ганта»<widget_gantt>`, то на ней отображаются задачи и этапы проекта: их иерархия, сроки выполнения, а также зависимости между ними.

.. image:: _static/ept/simple_gantt_01.png
       :width: 700
       :align: center

Непосредственно на диаграмме можно создавать задачи и этапы, указывать сроки, устанавливать зависимости между задачами и этапами.

Для добавления задачи или этапа:

1. Нажмите **(a)** — для задачи/этапа, или **(b)** — для подзадачи/подэтапа.
   Элемент добавится в список.
2. Выберите тип **(c)**.
3. В панели справа заполните поля о задаче/этапе **(d)**.

.. image:: _static/ept/simple_gantt_02.png
       :width: 600
       :align: center

Созданная на диаграмме задача отобразится в разделе **Задачи проекта** или **Этапы** в зависимости от выбранного типа.

.. image:: _static/ept/simple_gantt_03.png
       :width: 700
       :align: center

Подробно о функционале см. :ref:`«Диаграмма Ганта»<widget_gantt>`.


Учет времени
""""""""""""""""""

См. выше :ref:`Учет времени<ept-time-tracking>`


Библиотека документов
""""""""""""""""""""""""""""""""""""

См. выше :ref:`Библиотека документов<ept-document-library>`
...
4. В журнале **Camel DSL** (Рабочее пространство «Раздел администратора» → Интеграция ) создайте маршрут с контекстом на основе примера выше. Обязательно укажите параметры подключения к Jira, ``_workspace`` и ``link-project:project``.
