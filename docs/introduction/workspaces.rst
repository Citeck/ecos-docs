...
1. Для пользователя, не являющегося участником публичного пространства, доступно действие: Присоединиться.
2. для пользователя, являющегося участником публичного пространства, доступно действие действия: Перейти в пространство и Выйти из пространства.
3. для пользователя, являющегося участником приватного пространства, доступно действие: Перейти в пространство и Выйти из пространства.
4. Если текущий пользователь является единственным менеджером публичного или приватного пространств, то при попытке выйти из пространства отображается сообщение: "Вы не можете покинуть пространство, так как являетесь единственным менеджером".
5. Для пользователей с ролью "менеджер" доступна возможность удалить публичное или приватное пространства.
