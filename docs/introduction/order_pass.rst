...
.. list-table::
      ...
      * - **Делопроизводитель**
        - Сотрудники, входящим в группу «Делопроизводители» и, соответственно, включенным в роль с таким же названием, согласующие пропуск.
...
.. list-table::
      ...
      * - **Пропуск заказан**
        - В случае одобрения по задаче «Оформление пропуска».
      * - **В пропуске отказано**
        - В случае отказа по задаче «Оформление пропуска».
