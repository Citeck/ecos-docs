Домашняя страница Citeck и ее элементы
========================================
...
- осуществлять **поиск (1)** по сущностям (документам), людям, рабочим пространствам:
...
Сущности для поиска настраиваются. См. подробно
