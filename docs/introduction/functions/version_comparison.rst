...
**Сравнение версий** — функция, позволяющая наглядно увидеть отличия между двумя версиями документа: добавленные, изменённые и удалённые фрагменты подсвечиваются прямо в интерфейсе.
