...
Функционал позволяет импортировать данные из файлов Excel по заранее настроенному шаблону — в результате в системе автоматически создаются карточки записей выбранного типа.
...
Также в систему по предварительно заполненному шаблону можно загрузить пользователей и группы.
