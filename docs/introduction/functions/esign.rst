...
Электронно-цифровая подпись (ЭЦП) в Citeck позволяет подписывать документы с использованием квалифицированных сертификатов КриптоПро, обеспечивая их юридическую значимость. Подписание выполняется непосредственно в браузере в рамках бизнес-процесса — без выгрузки файлов и сторонних приложений.

Функция поддерживается для документов **ОРД**, **Исходящей корреспонденции** и **ЭДО**, а также для любых типов данных через настройку аспекта подписания.
