...
Citeck позволяет подписывать документы с использованием усиленной квалифицированной электронной подписи (УКЭП), обеспечивая их юридическую значимость. 

Функциональность поддерживается для документов **ОРД**, **Исходящей корреспонденции** и **ЭДО**, а также для любых типов данных через настройку аспекта подписания.
...
В модуле ОРД функция проверки скана подписанного документа становится недоступна.
...
См. :ref:`подробно<EDI_in_out>`

Любой тип данных
-------------------

См. :ref:`настройки<esign_settings>`
