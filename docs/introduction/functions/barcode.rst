...
Citeck позволяет автоматически формировать PDF-документ со встроенным штрихкодом — это упрощает идентификацию и отслеживание документов в рамках бизнес-процессов. Функционал реализован с использованием микросервиса :ref:`ecos-transformations <transformation>` и инструмента PDFStamp.
