...
В рабочем пространстве **Договоры** доступно :ref:`дерево категорий<category_tree>`.

Во всех рабочих пространствах настроен :ref:`предпросмотр данных карточки<preview>`.
