...
**Функциональные модули** — готовые к использованию компоненты платформы Citeck, предназначенные для автоматизации бизнес-процессов конкретных предметных областей. Каждый модуль охватывает полный цикл работы с бизнес-объектом: типы данных, журналы, процессы обработки, уведомления и настройки интерфейса — всё необходимое для решения прикладных задач без дополнительной разработки.

Модули доступны «из коробки» и могут быть настроены под процессы конкретной организации: расширены дополнительными полями, встроены в сквозные бизнес-процессы или интегрированы с внешними системами.
...
Доступны следующие возможности и примеры:

- рабочем пространстве :ref:`Договоры<ecos-contract>` доступно :ref:`дерево категорий<category_tree>`;
...
- предзаполненный пример :ref:`персонального рабочего пространства<ws_personal>` доступен для пользователя **elvira.danilenko**;
- предзаполненный пример :ref:`совместного рабочего пространства<ws_collaborative>` доступен для пользователей **elvira.danilenko** и **pavel.elbrusov**.
