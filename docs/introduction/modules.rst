...
- использовать готовые :ref:`модули <ecos_modules>`;
- создавать, исполнять и контролировать :ref:`бизнес-процессы <ecos-bpmn_platform>` любой сложности;
- хранить контент различных форматов, структурировать его и управлять правами доступа.

**Citeck Enterprise** включает весь функционал **Citeck Community** и дополнительно предоставляет:
