...
По умолчанию **Оргструктура** представлена в виде вкладок **(1)**, где по умолчанию открывается **По уровням**. Воспользуйтесь стройкой поиска при необходимости **(2)** и выберите сотрудника, нажав на **(3)**:
