...
.. code-block:: json
    ...
    {
        "id" : "ssg-incident-base-new-incident-to-possible-responsible",
        "name" : "ББазовый шаблон. Новый документ",
        "notificationTitle" : {
...
-------------------------------------
В шаблонах уведомлений доступны переменные, определенные в модели, см `1.1 Описание сущности “Шаблон уведомления“`_ блок «Model».

3.1 Множественные атрибуты
~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
3.2 Вставка изображений в шаблон
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
