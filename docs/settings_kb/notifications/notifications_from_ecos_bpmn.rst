...
4. Приглашение в календарь (iCal)
-----------------------------------
...
7. Дополнительная модель (additional meta)
---------------------------------------------
