...
.. list-table::
      ...
      * - 2
        - **Префикс**
        - | Предназначен, чтобы различать атрибуты из разных аспектов.
...
.. list-table::
      ...
      * - 6
        ...
        - функционал, позволяющий установить выражение-зависимость, позволяющий гибко создавать производные атрибуты :ref:`См. подробно<attribute_rights>`
...
Аспект **"Связан с другим документом"** создан для работы виджета **"Связи документа"** (добавление и отображение связей с сущностью ):
...
Для реализации сложной логики - необходимо создать :ref:`вычисляемый атрибут<count_attributes>`, и на основе него добавить аспект и далее брать настройку штрих-кода из атрибута.
...
Также можно вносить атрибуты непосредственно в json:
...
.. note:: 
      ...
      Если в типе присутствуют обязательные атрибуты, которых нет в журнале, они будут добавлены в конец столбцов в шаблоне.
