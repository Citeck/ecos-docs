...
Параметры режима цвета значения
**************************************
...
- Когда ``showPointer: true`` - отображает маленький цветной кружок перед текстом.
- Когда ``showPointer: false`` - отображает текст на закругленном овальном цветном фоне.
