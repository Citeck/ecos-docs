...
Журналы — основной инструмент для отображения и управления записями в Citeck. Они представляют данные в табличной форме с возможностью настройки колонок, фильтрации, сортировки, группировки и выполнения действий над записями. Конфигурация журналов хранится в сервисе ``ecos-uiserv``.
