...
Отображение записей, которые отфильтрованы по выбранному из списка значению, независимо от того выводится в колонке стандартный атрибут ассоциации или нестандартный
---------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
2. Если  нужен поиск по ассоциации, но в колонке должно отображаться имя сущности, то тут есть два пути:
