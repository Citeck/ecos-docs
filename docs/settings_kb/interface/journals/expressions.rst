...
В журналах ECOS помимо простых атрибутов (``name``, ``counterparty`` и др.) можно использовать выражения — SQL-подобные конструкции, вычисляемые в момент запроса к базе данных. Они поддерживают математические операции, функции работы с датами, а также поиск, группировку и сортировку с гарантией актуальности данных.
