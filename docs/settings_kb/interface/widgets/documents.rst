...
Доступно отображение только выбранных типов по соответствующему чекбоксу:

.. image:: ../_static/widgets/documents_03.png
   :width: 600
   :align: center

При выборе типа чекбоксом и наведении мышки на строку становится доступна настройка выбранного типа документа:
