...
Настройки диаграммы Ганта включают в себя следующие:
...
Управление задачами и ручной ввода данных
--------------------------------------------
...
Перейдите в рабочее пространство проекта, в настройках страницs добавьте виджет **Диаграмма Ганта**.

В настройках виджета выберите **Тип данных** - **Связанная - Подключение в бизнес-процессу**. 
