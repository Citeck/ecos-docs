...
.. dropdown:: Реализация
   ...
   2. Вместо **calculated value** логика подтягивания записей перенесена в раздел компонента **«Logic»** (table form).
