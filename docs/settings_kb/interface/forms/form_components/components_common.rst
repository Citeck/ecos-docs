...
Редактор форм платформы Citeck включает набор компонентов, сгруппированных по назначению: **Основные** — для ввода и выбора данных, **Расширенные** — специализированные компоненты платформы, **Макет** — для структурирования формы, **Данные** — для работы с данными без отображения пользователю.
