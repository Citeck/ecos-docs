...
Компонент предназначен для выбора значения из списка. Основан на стандартном formio-компоненте **Select** и модифицирован так, чтобы список возможных значений формировался автоматически.
