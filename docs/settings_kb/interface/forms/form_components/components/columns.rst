...
Контрол **Columns** позволяет организовать элементы формы в несколько столбцов. Поддерживает настройку ширины каждого столбца под разные размеры экрана и применение произвольных CSS-классов к ячейкам.
