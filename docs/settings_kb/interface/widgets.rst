...
**Воронка** используется для визуализации последовательных этапов процесса, где количество элементов уменьшается на каждом шаге.

 .. image:: _static/widgets/chart_11.png
       :width: 600
       :align: center 

При клике на любой из уровней графика открывается журнал со списком сущностей, относящихся к признаку группировки. 
...
.. list-table:: 
      ...
      * - **Стадии воронки**
        - Выбор стадий и цвета их отображения на воронке.
