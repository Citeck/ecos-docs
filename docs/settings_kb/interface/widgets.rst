...
- **Упрощенный режим:**
  ...
  * **бизнес-процесс (1)**, 
  * **целевые значения KPI**, отклонения значения KPI от целевого значения **(2)**,
  * **% экземпляров**, ушедших по каждой ветке после шлюза **(3)**.
...
- **Расширенный режим:**
 ...
 При максимальных настройках по умолчанию в расширенном режиме доступны:
    ...
    * **% экземпляров**, ушедших по каждой ветке после шлюза **(5)**.
