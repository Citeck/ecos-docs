...
**Виджет «Активности»** модуля CRM помогает планировать и организовывать работу со сделками, лидами, представителями компаний. Задачу, связанную с продажами: телефонный звонок, встречу, письмо, поручение можно запланировать из карточки сделки и просмотреть в календаре. |br|
Вы можете отслеживать этапы работы со сделкой и просматривать все запланированные и завершённые задачи (активности). |br|
...
Кроме того, их можно просматривать:
...
.. list-table:: 
      ...
      * - | 
        ...
        - |  Планируемая активность создана. 
      ...
      * - | 
        ...
        - |  Наступила дата и время активности. 
          |  Назначается задача ответственному. См. подробно про :ref:`задачу<activity_task>`
...
Если работа по активности не завершена, то заполните в задаче **результат** и нажмите **«Выполнено»**. Статус активности с **«Просрочена»** изменится на **«Выполнена»**.
...
Функционал аналогичный комментариям в других модулях системы.
...
Активность запускает функционал :ref:`поручения<ecos-assignments>`. По умолчанию указан **инициатор**:

 .. image:: _static/widgets/activity/activity_24.png
       :width: 500
       :align: center 

Укажите **название**, выберите **срок**, **приоритет**, ***исполнителя***:
