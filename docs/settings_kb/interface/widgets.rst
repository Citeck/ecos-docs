...
Виджет отображает ближайшие дни рождения. Данные берутся из профиля пользователя.
...
Виджет «Новости» показывает анонсы последних 3 новостей из раздела **«Новости»**:
