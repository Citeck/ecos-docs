...
**Упрощенный режим** – отображается только бизнес-процесс:
            ...
            .. image:: _static/widgets/Process_statistics_01.png
                 :width: 600  
                 :align: center 

**Расширенный режим:**

            .. image:: _static/widgets/Process_statistics_02.png
                 :width: 600  
                 :align: center 
...
Виджет добавляет в карточку :ref:`канбан доску<kanban_board>` с настраиваемым журналом и шаблонами для удобства пользователя и быстрым взаимодействием со статусами через карточку.
...
.. list-table:: 
      ...
      * - | **Настройка**
        ...
        - |  
          ...
          | Выбор сохраненных шаблонов журнала и досок
