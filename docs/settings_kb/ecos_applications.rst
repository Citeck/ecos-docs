...
Интеграция с Git позволяет связать ECOS приложение с Git репозиторием и по нажатию на действие «Зафиксировать изменения в Git» загрузить изменившиеся артефакты в указанный репозиторий.
