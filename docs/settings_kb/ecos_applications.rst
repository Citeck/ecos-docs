...
**Приложения Citeck (ECOS Apps)** — механизм упаковки, переноса и версионирования :ref:`артефактов<ecos_artifacts>` платформы ECOS между различными стендами. Приложение представляет собой zip-архив, содержащий метаданные и набор артефактов: типы данных, формы, журналы, шаблоны и другие элементы конфигурации системы.
