...
**Артефакты** — базовые единицы расширения и конфигурации платформы ECOS. Любой элемент системы — тип данных, форма, журнал, процесс, шаблон уведомления — является артефактом. Артефакты хранятся в микросервисе **ecos-apps**, который управляет их версионностью и доставкой до целевых микросервисов.
