...
.. dropdown:: Вариант 1. Скопировать журнал из карточки типа данных
   :color: secondary
...
.. dropdown:: Вариант 2. Через настройки уже добавленного в меню журнала
   :color: secondary
...
.. dropdown:: Вариант 1. Скопировать форму из карточки типа данных
   :color: secondary
