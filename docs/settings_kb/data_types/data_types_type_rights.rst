...
Помимо матрицы прав на объекты (записи) в ECOS существует отдельный механизм управления доступом к самим **описаниям типов данных** — кто может просматривать, изменять или создавать дочерние типы.
