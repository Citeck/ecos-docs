...
Роли назначены на группы. Чтобы пользователь получил права, необходимо добавить его в соответствующую группу (bp-administrator, bp-manager, bp-developer, bp-viewer).
