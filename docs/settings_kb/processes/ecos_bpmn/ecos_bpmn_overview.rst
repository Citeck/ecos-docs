...
**Citeck BPMN** — встроенный инструмент моделирования и исполнения бизнес-процессов на базе стандарта BPMN 2.0. Он позволяет визуально описывать логику работы: маршрутизацию задач, ветвления, таймеры, интеграции с внешними системами — и сразу запускать созданные схемы в производственной среде без написания кода.

Платформа основана на библиотеке редактора `bpmn-js <https://bpmn.io/toolkit/bpmn-js/>`_ и движке `camunda <https://camunda.com/>`_. Редактор поддерживает полный цикл работы с процессом: создание и редактирование схемы, публикацию (деплой), мониторинг запущенных экземпляров и администрирование.
