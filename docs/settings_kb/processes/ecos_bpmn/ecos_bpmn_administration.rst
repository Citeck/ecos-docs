...
- **Информация о процессе** — сводные данные по definition: доступные действия (включая миграцию версий), схема и журнал с экземплярами, инцидентами и фоновыми задачами;
- **Экземпляр процесса** — детальный разбор конкретного instance: управление состоянием (приостановить, возобновить, удалить), переменные, вызываемые процессы, инциденты и внешние задачи.
