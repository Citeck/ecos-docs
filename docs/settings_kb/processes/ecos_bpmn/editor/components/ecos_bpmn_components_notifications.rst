...
Имя и тип уведомления
~~~~~~~~~~~~~~~~~~~~~~

Указать **Имя**, **Тип уведомления** указан по умолчанию **Электронная почта**.

.. image:: _static/notifications/49.png
   :width: 350
   :align: center

Шаблон или текст сообщения
~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
.. tab-set::
   ...
   .. tab-item:: Шаблон уведомления

      Можно выбрать :ref:`шаблон уведомления <notification_templates>`.

      .. image:: _static/notifications/50.png
         :width: 350
         :align: center

   .. tab-item:: Заголовок и тело сообщения

      Или напрямую указать **Заголовок** и **Тело** сообщения.

      .. image:: _static/notifications/51.png
         :width: 350
         :align: center

Отправка писем-встреч в календарь
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
.. tab-set::
   ...
   .. tab-item:: Выражение
      ...
      **Организатор** — имя, recordRef или емейл организатора. Конечным результатом обработки поля будет являться email.
      ...
      Поддерживаются expression для получения данных из переменных или сервисов. Например:
      ...
      **Продолжительность события** указывается в `ISO 8601 <https://en.wikipedia.org/wiki/ISO_8601>`_ формате. Например:
...
Исходящий адрес и дополнительные настройки
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

**Исходящий адрес** — исходящий адрес уведомления. Может быть указан напрямую или через expression. Если пусто, то будет использовано значение по умолчанию. Например:
