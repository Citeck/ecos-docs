...
.. important::
  ...
  При сохранении, сохранении/публикации процесса проверяется следующее:
   ...
   - **«Тип условия»** (Исходящий или Выражение, или Скрипт) должен быть обязательно выбран, если поток выходит из эксклюзивного и инклюзивного шлюза.
   - Если поток не выходит из эксклюзивного и инклюзивного шлюза, то **«Тип условия»** может быть равен только **«Нет»**.
