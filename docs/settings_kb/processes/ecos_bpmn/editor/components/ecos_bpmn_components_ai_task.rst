...
Задача выполняет однократный вызов LLM без памяти о предыдущих обращениях. Вызов из процесса преднастроенного :ref:`AI-агента <user-agents>` с его набором инструментов — отдельная возможность, которая будет доступна в следующих релизах.
