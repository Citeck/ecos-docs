...
В Citeck реализована low-code платформа для автоматизации бизнес-процессов, которая использует нотацию BPMN (Business Process Model and Notation) для моделирования и выполнения процессов. 
