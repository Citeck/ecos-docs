...
Citeck поддерживает подписание документов электронной цифровой подписью (ЭЦП) с использованием сертификатов КриптоПро. Функционал подписания ЭЦП может быть добавлен к любому типу данных. Для этого предусмотрены специальная настройка виджета **«Свойства»** и действия.
