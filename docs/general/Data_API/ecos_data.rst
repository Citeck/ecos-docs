...
**ecos-data** - библиотека, которая позволяет добавлять новые Records DAO, записи которых будут храниться в БД.
...
В Citeck по умолчанию для типов предусмотрено хранение в микросервисе **ecos-model**. Для этого достаточно на форме типа
...
.. dropdown:: Правила генерации sourceId
   :color: secondary
...
здесь **counterparty** - ассоциация на контрагента, а **fullOrganizationName** - его имя.
...
.. dropdown:: Функции форматирования данных
   :color: secondary
