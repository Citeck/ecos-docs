...
В панель инструментов консоли разработчика добавлена кнопка :ref:`AI Ассистент <AI_assistant>` — позволяет использовать AI для генерации и редактирования кода прямо в консоли.

.. image:: _static/console/03.png
    :width: 600
    :align: center

Например, можно попросить AI Ассистент написать код для получения списка всех пользователей:
