...
Микросервисы взаимодействуют с платформой через Records API и систему команд, что позволяет добавлять собственную бизнес-логику и интеграции. В данном разделе описан демонстрационный микросервис и руководство по созданию нового микросервиса с нуля.
