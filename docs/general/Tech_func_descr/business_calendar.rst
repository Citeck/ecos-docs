...
Совместно они позволяют гибко настраивать рабочий график сотрудников и используются в различных модулях системы — например, для расчёта SLA в модуле «Service Desk».
...
Сущность нужна для формирования списка дат, которые изменяют обычный распорядок рабочих дней.
