...
В таком случая для первого документа подпишется контент из атрибута c**ontentCustom**, для второго документа подпишется контент из атрибута content (при наличии).