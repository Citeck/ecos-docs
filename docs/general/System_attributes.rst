        ...
        - | алиас сущности при сабмите. Используется, когда нужно создать несколько связанных сущностей. 
          ...
          | Например, хотим создать 2 сущности:
              ...
              .. code-block::
                    ...
                    [
                    {"id": "emodel/some-type@", "attributes":{"link":"alias-value-0"}}, // тут link - ассоциация. В ней мы пишем значение алиаса
                    {"id": "emodel/some-type@", "attributes":{"_alias":"alias-value-0"}, // тут _alias - тот фейковый id под которым эта сущность представлена
                    ]
