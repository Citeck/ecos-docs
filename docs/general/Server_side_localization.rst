...
На данный момент локализованы стандартные ошибки **Permissions Denied**:

    1) Permissions Denied. You can't change attributes $deniedAtts for record (При попытки изменить атрибут, без прав на редактирование атрибута)
    2) Permissions Denied. You can't change record (При попытки изменить запись, без прав на редактирование)
    3) Permissions Denied. You can't delete record (При попытки удалить запись, без прав на редактирование)