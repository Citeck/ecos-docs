...
""""""""""""""""""""""""""""""""""""""""""""""""""
В микросервисе нотификаций должно быть заданы firebase credential-class-path и data-base-url. На данный момент на стенды доставляется в комплекте поставки микросервиса. Для локальной разработки нужно указать путь для тестовых crdentials.
