...
:ref:`Основные<datatypes_main>` – основные характеристики типа данных.

:ref:`Атрибуты<datatypes_attributes>`– характеристика, определяющая свойства объекта.

:ref:`Роли<datatypes_roles>` – роли, которые участвуют в работе с объектом,

:ref:`Статусы<datatypes_statuses>`– статусы, по которым объект будет перемещаться по мере выполнения бизнес-процесса

:ref:`Варианты создания<datatypes_create>` – настройка поддержки выбора варианта создания после выбора типа
