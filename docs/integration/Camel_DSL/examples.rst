...
Возможность добавить в журнал нужного типа кнопку **«Импорт»**. При нажатии на которую появляется список возможных вариантов, где пользователь сначала выгружает шаблон в Excel, заполняет данные и загружает файл в Систему. 
...
Для настройки Импорта данных необходимо выполнить следующие шаги:

**1)**	Создать Camel DSL с Типом запуска IMPORT_DATA и описать в нем процесс обработки файла 
...
Конфиг импорта для варианта **«По умолчанию» - default-import-data** 
...
**3)**	Добавить в необходимый тип данных аспект **import-data-config (Импорт данных)** и настроить вариант, указав Camel DSL созданный на предыдущем пункте.
