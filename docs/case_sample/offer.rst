...
В данном примере будет рассмотрено создание модели процедуры выдачи HR-оффера, включающей в себя зависимые типы, а именно основной тип кейса, управляющий процессом создания и согласования оффера, а также типы-справочники.
...
далее основной тип-кейс – Офферы.
