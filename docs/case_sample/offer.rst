...
При создании типа по умолчанию создается связанный с ним журнал. Так же журнал можно создать :ref:`вручную<new_journal>`.

  .. image:: _static/offer/auto_journal/01.png
       :width: 600
       :align: center

Журнал имеет следующий формат наименования: **type$idтипа**

  .. image:: _static/offer/auto_journal/02.png
       :width: 600
       :align: center

И содержит в качестве столбцов все созданные атрибуты типа:
