...
Пояснение к пп. 3 и 8: номер можно присваивать автоматически и отражать в шаблоне отображения имени. Для этого необходимо задать и настроить :ref:`Шаблон нумерации<number_template>`.
...
При создании типа данных по умолчанию создаётся :ref:`автоматически генерируемая форма и журнал<auto_journal_form>`.
...
При создании типа данных по умолчанию создаётся связанный с ним :ref:`автоматически сгенерированный журнал<auto_journal>`. Такой журнал получает идентификатор вида **type$idтипа**.
...
Автоматически созданный журнал может полноценно использоваться в системе и быть добавлен в :ref:`меню<menu>`.
...
Рассмотрим на примере справочника **«Города»**.

Перейдите в :ref:`созданное рабочее пространство<demo_ws>`: 

  .. image:: _static/offer/ws.png
       :width: 700
       :align: center
...
3. В поле **«Название»** введите название раздела. Например, **Справочники**. Нажмите **«Сохранить»**.
...
5. Выберите журнал **«type$city»** и нажмите **ОК**:

  .. image:: _static/offer/menu_5.png
       :width: 600
       :align: center

6. Для сохранения меню нажмите **Применить**:
...
Аналогичным образом добавьте в меню справочники **Офис**, **Тип должности**, **Грейд**, **Социальный пакет**, **Должностные обязанности**, **Кандидат**:
  ...
  .. image:: _static/offer/menu_6_1.png
       :width: 700
       :align: center
...
.. list-table::
      ...
      * - Укажите **Реципиентов** – исполнителей задачи, выбираются из списка ролей, заполненных :ref:`типе данных<roles_offer>`
...
4. Для сохранения меню нажмите **Применить**

     .. image:: _static/offer/bmpn32_1.png
          :width: 600
          :align: center

5. Добавленный пункт меню:
