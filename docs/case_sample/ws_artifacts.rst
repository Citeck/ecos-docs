...
**«Артефакты ECOS»** предназначен для управления созданными локальными артефактами. В данный журнал попадают все артефакты, которые достигли микросервиса ecos-apps.

 .. image:: _static/ws_artifacts/ws_artifacts_01.png
       :width: 800
       :align: center
...
* Скачивается **zip** архив со всеми версиями артефакта с указанной даты.
...
.. seealso::
   ...
   Подробно про артефакты и их источники описано в :ref:`статье<ecos_artifacts>`.

Упаковка приложения для переноса артефактов
-----------------------------------------------

В рабочем пространстве перейдите в раздел **Администрирование** выберите пункт **Приложения ECOS**. Нажмите **+ — Создать приложение**:

.. image:: _static/ws_artifacts/ws_app_01.png
   :width: 800
   :align: center
...
.. image:: _static/ws_artifacts/ws_app_02.png
   :width: 600
   :align: center

При необходимости дополните список вручную, нажав **+**.

.. image:: _static/ws_artifacts/ws_app_03.png
   :width: 600
   :align: center
...
.. image:: _static/ws_artifacts/ws_app_04.png
   :width: 700
   :align: center
...
Чтобы загрузить приложение в другое рабочее пространство, нажмите Нажмите **+ — Загрузить приложение**:

.. image:: _static/ws_artifacts/ws_app_05.png
   :width: 500
   :align: center

.. seealso::

   Подробно про приложения описано в :ref:`статье<applications>`.