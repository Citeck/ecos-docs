...
Для этого следует выполнить следующие действия:
 ...
 -	В верхней части нажмите **«Создать»**, выберите вариант **«Создать форму»**:
  ...
  Компонент **Task Outcome** автоматически сформирует кнопки вердиктов, исходя из настроек **Результатов задачи**.
...
В персональном рабочем пространстве в левом меню перейдите в **Текущие задачи**, откройте задачу, нажав:
