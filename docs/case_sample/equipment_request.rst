...
1. После **Gateway** необходимо поставить 2 элемента смены статуса на **«Согласовано»/ «Отказано»**. Для этого повторяем действия первой смены статуса (пункт 2):
...
Зайдите под **Согласующим**:

Откройте персональное рабочее пространство и далее в левом меню перейдите в **Текущие задачи**, откройте задачу, нажав:
