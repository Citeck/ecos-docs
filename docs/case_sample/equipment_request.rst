...
.. note::
  ...
  Так же менеджер рабочего пространства может создать тип данных, бизнес-процесс для использования внутри рабочего пространства. :ref:`См. подробно<ws_artifacts>`
...
Заявка перейдет в статусе **«Заявка создана»** и откроется ее карточка. 
