...
Для этого следует выполнить следующие действия:
 ...
 -	В верхней части нажмите **«Создать»**, выберите вариант **«Создать форму»**:
  ...
  -	Чтобы согласующий мог внести комментарий при согласовании, добавьте компонент **Text Area**:

   .. image:: _static/equipment_request/form_common_3_2.png
       :width: 600
       :align: center

   В поле **«Название поля»** введите **Комментарий**, в поле **«Имя свойства»** -  **comment**:

   .. image:: _static/equipment_request/form_common_3_3.png
       :width: 600
       :align: center

   Нажмите кнопку **«Сохранить»**

   .. image:: _static/equipment_request/form_common_3_4.png
       :width: 600
       :align: center
 ...
 -	На кнопке **«Отменить»** нажмите на кнопку редактирования (шестерёнка):
    ...
    -	Имя свойства -  **outcome_Reject**
    -	Название поля - **Отказать**
    -	Действие - **Submit**
