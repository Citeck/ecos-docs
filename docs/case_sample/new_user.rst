...
.. note::
      ...
      Также пользователи могут быть созданы через Keycloak.
...
На запущенном проекте перейдите по ссылке `http://localhost/ecos-idp/auth <http://localhost/ecos-idp/auth>`_.

Перейдите в раздел **Administration Console**:
...
Введите как минимум **username** и нажмите **Сохранить**.

Для ввода пароля перейдите во вкладку **Credentials**, введите и подтвердите пароль.

.. image:: _static/new_user/User_6.png
   :width: 600
   :align: center

Если пароль необходимо сделать временным, выставите **Temporary ON**.
