...
Для создания Модели принятия решений необходимо перейдите через верхнее меню **«Раздел администратора – Управление процессами – DMN»**.
      ...
      * - **3**
        ...
        - | К задаче необходимо создать форму. 
           ...
           * Название формы – **«Форма согласования заказа мебели»**
             ...
             .. image:: _static/dmn_dynamic_role/23.png
                  :width: 400
                  :align: center
