...
**Hit policy (2)** — :ref:`политика выбора<dmn_hit_policy>`. Определим её как **Unique** (по умолчанию).
...
Для установки наименования выходного элемента дважды кликните поле под **Then** и введите **«Согласующий»**:
...
В форме выберите тип **DMN**, решение — **Decision_furniture**:
