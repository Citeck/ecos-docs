...
.. warning::
  ...
  Launcher 1.x устарел (deprecated), использовать его не рекомендуется.
  Начиная с Citeck релиза **2026.3** корректная работа гарантируется только с Launcher версии **2.x**.
...
.. note::
    ...
    Указанные объёмы рассчитаны на локальную работу и демонстрации. Enterprise-поставке 16 ГБ недостаточно: с полным набором приложений она уже без нагрузки занимает около 16 ГБ. Требования к ресурсам для рабочих контуров — :ref:`Сайзинг на одной ВМ <sizing_docker>`.
