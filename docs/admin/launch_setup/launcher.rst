...
- Быстрый локальный запуск Citeck Community и Enterprise — с :ref:`демонстрационными данными <ecos_modules>` или без них.
...
- Обновление Citeck Community и Enterprise  без потери данных.
- Поддержка нескольких рабочих пространств с независимыми конфигурациями.

.. note::

 Начиная с версии 2.0 доступна не только локальная, но и серверная установка. 
