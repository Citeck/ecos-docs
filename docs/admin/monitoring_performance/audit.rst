...
Доступные типы событий (``records.query-records``, ``records.get-records-atts``, ``records.mutate-record``, ``records.delete-records``) и общий вид записи о событии описаны ниже, см. :ref:`Описание аудита<ecos_audit_description>`.

.. _ecos_audit_description:
