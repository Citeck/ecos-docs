...
1.	Перейти в соответствующий реалм Citeck. В рабочем пространстве **«Раздел администратора»** открыть пункт меню **Пользователи**, для добавления нового пользователя нажать кнопку :guilabel:`+`:
