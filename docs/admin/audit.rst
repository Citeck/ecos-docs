...
**records:** List<EntityRef> // Список записей, который вернулись в результате запроса. Описание **EntityRef** см. ниже
...
**record:** EntityRef // Ссылка на запись в источнике данных. Описание **EntityRef** см. ниже
...
**record:** EntityRef // Ссылка на запись в источнике данных. Если record имеет вид ``"{{appName}}/{{sourceId}}@"`` (т.е. после знака @ ничего нет), то это означает, что пришел запрос на создание новой сущности.  Описание **EntityRef** см. ниже
...
**records:** List<EntityRef> // Список записей для удаления. Описание **EntityRef** см. ниже
