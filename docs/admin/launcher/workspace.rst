...
.. note::
    ...
    Для создания токена зайдите в **GitLab → Слева нажмите на свой аватар → Preferences → Access Tokens**. Создайте новый **токен** и скопируйте его значение.

Далее введите токен в соответствующее поле и подтвердите:
