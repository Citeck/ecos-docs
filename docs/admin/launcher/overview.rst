...
1.  **Список volumes**, которые используются. Их можно очистить, сделать :ref:`снапшот данных<launcher_dump>`:

    .. image:: _static/volumes.png
        :width: 400
        :align: center

2.   **Работа с секретами**, используемыми в лончере. Сначала необходимо задать мастер-пароль: 
