...
•	Скачайте `репозиторий <https://github.com/Citeck/ecos-community-demo/archive/refs/heads/master.zip>`_  
•   Распакуйте архив в локальную папку.
•	в терминале: 

    - перейдите в папку с распакованным архивом ``cd полный путь до папки`` 
