...
1. Возможность :ref:`просмотреть вид уведомления<notifications-label>`, которое было отправлено через журнал уведомлений.

2. Возможность :ref:`настройки отображения событий<history-config_aspect>` в истории и в виджете «История событий». 

3. Оптимизирована загрузка открытых вкладок. 
